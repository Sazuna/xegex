...
export function createNewRegexElements(regex, description) {
     /*<div class='regex-entry'>
      <div class="bg-light w-100 hover-me mb-0 amt-1"><p>\d+km/h</p><input type="text" placeholde    r="Modifier la regex" value="" style="width: -moz-available; display: none"></div>
      <small class="show-me mb-0 ml-4">Vitesse en km/hblablabla blablabla blablabla</small>
      <input class="show-me mb-0 ml-4" type="text" placeholder="Description de la regex" style="w    idth: -moz-available; display:none">
     </div>
    */
...
/*	var divElement = $("<div>").addClass("col-12")
				...
				.addClass("col-lg-4")
				.addClass("col-xl-3")
				.append(regexInputElement)
				.append(regexTextElement);
*/
