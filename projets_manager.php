   ...
   <fieldset class="col-6 border p-3 active">
    ...
    <div id='regex'>
     <div class='regex-entry'>
      <div class="bg-light w-100 hover-me mb-0 amt-1"><p>\d+km/h</p><input type="text" placeholder="Modifier la regex" value="" style="width: -moz-available; display: none">
      </div>
   ...
   <div class="col-1"></div> <!-- div d'espacement -->
    <fieldset class="col-5 border p-3 active">
     ...
     <div class="form-group row mt-2" id="lexique">
      <div class="col-12 col-md-6 col-lg-4 col-xl-3 lexique-entry"><span class='lexique-text' style="display:none">Example</span><input type="text" class="lexique-input" value="au revoir" style="width:-moz-available">
      </div>
     </div>
    </fieldset>
   </div>
